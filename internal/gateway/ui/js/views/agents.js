...
import { stopSweep, setPaused, refreshAgent, refreshStatus, syncStopButtons } from '../actions.js';
...
export function renderAgents() {
  ...
  root.querySelector("#agentsPause")?.addEventListener("click", async () =>
    setPaused(!(state.status && state.status.paused))
  );
